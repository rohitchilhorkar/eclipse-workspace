...
public class PhoneBook {
	...
	//By default it has a package scope
	int ame=90; 
...
//		Can't use name of the constructor, must use PhoneBook
	...
	public void updateNumber(String name, String newNo) {
		Contact current = search(name);
		current.setMobileNumber(newNo);
	}
